...
describe('Search component', () => {
  ...
  beforeEach(() =>
    render(
      <MemoryRouter initialEntries={['/search/kale/1']}>
        <Routes>
  ...
  test('should show recipes and pages correctly and able to go to next page', async () => {
    ...
    expect(useFetchSpy).toHaveBeenCalledWith('complexSearch', 15, 'query', 'kale', '1');
    ...
    expect(mockUseNavigate).toHaveBeenCalledWith('/search/kale/2');
  });
});
